...
Route::get('/admin/sms', array('as' => 'AdminSms', 'uses' => 'AdminController@sms'));
Route::post('/admin/sms/send', array('as' => 'Adminsmssend', 'uses' => 'AdminController@sendsms'));
...
Route::get('/web/test', array('as' => '/web/test', 'uses' => 'WebController@test'));
Route::post('web/test', array('as' => '/web/test', 'uses' => 'WebController@test'));
