...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		final float fillRadius = res
				.getDimension(R.dimen.fill_circle_indicator_radius);
		...
		mRadius = a.getDimension(R.styleable.CirclePageIndicator_radius,
				defaultRadius);
		mRadiusFill = a.getDimension(R.styleable.CirclePageIndicator_radius,
				fillRadius);
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawCircle(dX, dY, mRadiusFill, mPaintFill);
	}
